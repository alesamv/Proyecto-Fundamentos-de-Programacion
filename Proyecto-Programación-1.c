...
{	
	...
	switch(op)
	{
		...
		case 1:
			...
			getch();
			system("cls");
			printf("Deseas consultar otro pediatra?\nSi(1)\nNo(2)\n");
			printf("Opcion: ");
			scanf("%d",&a);
			}while(a==1);
		break;
		case 2:
			...
			getch();
			system("cls");
			printf("Deseas consultar otro ginecologo?\nSi(1)\nNo(2)\n");
			printf("Opcion: ");
			scanf("%d",&a);
			}while(a==1);
			break;
		case 3:
			...
			getch();
			system("cls");
			printf("Deseas consultar otro Medico General?\nSi(1)\nNo(2)\n");
			printf("Opcion: ");
			scanf("%d",&a);
			}while(a==1);
			break;
		case 4:
			...
			getch();
			system("cls");
			printf("Deseas consultar otro urologo?\nSi(1)\nNo(2)\n");
			printf("Opcion: ");
			scanf("%d",&a);
			}while(a==1);
			break;
		case 5:
			...
			getch();
			system("cls");
			printf("Deseas consultar otro cardiologo?\nSi(1)\nNo(2)\n");
			printf("Opcion: ");
			scanf("%d",&a);
			}while(a==1);
		default:
			printf("Opcion no valida, por favor vuelva a intentar");
			break;
	}       
            printf("presiones enter para continuar...");
			getch();
			system("cls");
			printf("Deseas volver al menu de especialidades?\nSi(1)\nNo(2)\n");
			printf("Opcion: ");
			scanf("%d",&a);
			}while(a==1);
}
...
void pediatra()
{
	...
	switch(op){
		...
		case 1:
			...
			getch();
			system("cls");
			printf("Si aun no has agendado favor de agender\nDeseas regresar al menu de el medico?\nSi(1)\nNo(2)\n");
			printf("Opcion: ");
			scanf("%d",&a);
			}while(a==1);
			break;
		...
		case 2:
			...
			getch();
			system("cls");
			printf("Si aun no has agendado favor de agender\nDeseas ver de nuevo el menu de el medico?\nSi(1)\nNo(2)\n");
			printf("Opcion: ");
			scanf("%d",&a);
			}while(a==1);
